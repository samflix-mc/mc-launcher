//! The `version.json` files from Mojang and the loader.
...
pub(in crate::launch) use chain::{library_key, resolve_chain};
...
pub(super) struct VersionJson {
    ...
    /// Pre-2017 format, still present on very old versions.
...
/// An argument: either a plain string, or a value under a condition.
#[derive(Debug, Deserialize)]
#[serde(untagged)]
